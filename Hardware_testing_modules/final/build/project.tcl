...
set verilogSources [list "./source/alchitry_top.sv" "./source/reset_conditioner.sv" "./source/seven_seg.sv" "./source/lucid_globals.sv" ]
...
launch_runs -runs synth_1 -jobs 14
wait_on_run synth_1
